...
function get_data(traces, token, jigsaw_style_left){
    var traces = traces;
    var token = token;
    var trace_data_length = traces.length;  //长度根据实际情况而定
    var jigsaw_style_left = jigsaw_style_left;
...
token = "e459dc519c4e4b9fba362c10be01e5cb";
left = "198px"
console.log(get_data(trace, token, left))
console.log(get_cb())