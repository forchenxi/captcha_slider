        ...
        methods: {
            ...
            onMouseMove: function(e) {
                ...
                "dragend" !== i.status) {
                    ...
                    var origin = [Math.round(i.dragX < 0 ? 0 : i.dragX), Math.round(i.clientY - i.startY), a.now() - i.beginTime]
                    trace.push(origin)
                    var f = p(u,  origin+ "");
                    trace_e.push(f);
            ...
            onMouseUp: function(e) {
                ...
                Object.assign(t, w);
                jigsaw_style_left = this.$jigsaw.style.left;
